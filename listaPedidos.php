...
orders.orderNumber=orderdetails.orderNumber and orderdetails.productCode=products.productCode limit 50;";
...
$resultado = mysqli_query($db, $select);
		...
		if ($resultado && mysqli_num_rows($resultado) > 0) {
			...
			echo "<table border='2'>";
			echo "<tr>";
				echo "<th>Nombre de prodcuto</th><th>Cantidad</th><th>Precio unidad</th><th>Numero pedido</th><th>Fecha pedido</th><th>Estado</th>";
			echo "<tr>";
